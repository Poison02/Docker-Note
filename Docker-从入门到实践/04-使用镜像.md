...
*如果从 Docker Hub 下载镜像非常缓慢，可以参照* **03-安装Docker**一节配置加速器。
...
> 注意：如果您是初学者，您可以暂时跳过后面的内容，直接学习 [容器](https://yeasy.gitbook.io/docker_practice/container) 一节。
...
![image-20230718104803436](./assets/image-20230718104803436.png)
...
docker images
REPOSITORY   TAG       IMAGE ID       CREATED          SIZE
nginx        v2        7e7733c3fd33   15 seconds ago   141MB
nginx        latest    605c77e624dd   18 months ago    141MB
ubuntu       18.04     5a214d77f5d7   21 months ago    63.1MB
```
...
7e7733c3fd33   37 seconds ago   nginx -g daemon off;                            1.19kB    修改了默认网页
...
<missing>      19 months ago    /bin/sh -c #(nop) ADD file:09675d11695f65c55…   80.4MB
```
...
![image-20230718104524144](./assets/image-20230718104524144.png)
